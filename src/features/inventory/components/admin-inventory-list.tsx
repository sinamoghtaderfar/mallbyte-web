      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-600">
            Monitor stock across warehouses, reserved inventory, available
            quantities, and low-stock products.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="mt-6 overflow-x-auto rounded-2xl border border-slate-200">
            <div className="min-w-[1050px]">
              <div className="grid grid-cols-[1.7fr_1.2fr_0.7fr_0.7fr_0.7fr_0.7fr_0.9fr] gap-4 bg-slate-50 px-4 py-3 text-xs font-semibold uppercase tracking-wide text-slate-500">
                <span>Product</span>
                <span>Warehouse</span>
                <span>Total</span>
                <span>Reserved</span>
              ...
              <div className="divide-y divide-slate-100">
                {filteredStocks.map((stock) => (
                  <div
                    key={stock.id}
                    className="grid grid-cols-[1.7fr_1.2fr_0.7fr_0.7fr_0.7fr_0.7fr_0.9fr] gap-4 px-4 py-4 text-sm"
                  >
                    <div>
                    ...
                    <p className="text-slate-600">{stock.reserved_quantity}</p>
